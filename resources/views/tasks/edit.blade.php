<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <h2 class="text-2xl font-bold text-gray-900">Modifier la Tache</h2>
        </div>
    </x-slot>
                ...
                <form action="{{ route('tasks.update', $task) }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="4"
                                  class="mt-2 block w-full rounded-xl border-gray-300 shadow-sm focus:border-gray-900 focus:ring-gray-900 sm:text-sm">{{ old('description', $task->description) }}</textarea>
                    </div>
